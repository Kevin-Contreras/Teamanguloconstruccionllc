...
function FaqChevron() {
  return (
    <svg width={12} height={6} viewBox="0 0 14.4944 7.36683" fill="none" aria-hidden>
  ...
  return (
    <section id="faq" className="overflow-hidden bg-white pb-14 pt-16 lg:pb-0 lg:pt-20">
      <div className="mx-auto w-full max-w-[1420px] px-6 lg:px-[138px]">
        <h2 className="relative top-[40px] m-0 text-center text-[28px] font-bold leading-none sm:text-[32px] lg:text-[36px]">
